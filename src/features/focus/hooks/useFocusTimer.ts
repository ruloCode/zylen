 ...
 * so background-tab throttling self-corrects on the next tick and a
 * visibilitychange forces an immediate recompute. Terminal conditions
 * (time up / pause budget overrun) fire callbacks exactly once.
 */
