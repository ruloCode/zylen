  ...
  return (
    <div className="glass-card p-6 shadow-xl">
      ...
      <div className="grid grid-cols-3 lg:grid-cols-1 gap-3">
        {/* Level */}
        <div className="flex items-center gap-2 px-3 py-2.5 bg-white/5 rounded-lg border border-white/20">
          <Star className="text-teal-400 flex-shrink-0" size={20} />
          <div className="min-w-0">
            <p className="text-xs text-white/70 truncate">{t('common.level')}</p>
        ...
        {/* Total XP */}
        <div className="flex items-center gap-2 px-3 py-2.5 bg-white/5 rounded-lg border border-white/20">
          <TrendingUp className="text-[rgb(155,215,50)] flex-shrink-0" size={20} />
          <div className="min-w-0">
            <p className="text-xs text-white/70 truncate">{t('common.totalXP')}</p>
        ...
        <div className="flex items-center gap-2 px-3 py-2.5 bg-white/5 rounded-lg border border-white/20">
          ...
          <div className="min-w-0">
            <p className="text-xs text-white/70 truncate">{t('common.points')}</p>
