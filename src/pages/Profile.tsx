...
export function Profile() {
  ...
  const [selectedAvatar, setSelectedAvatar] = useState(user?.avatarUrl || ruloAvatar);
          ...
          {isEditingAvatar ? (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-400">{t('profile.avatarLabel')}</p>
                  <p className="text-white font-semibold">
                    {user.avatarUrl === ruloAvatar ? t('profile.avatarMale') : user.avatarUrl === daniAvatar ? t('profile.avatarFemale') : '-'}
                  </p>
                </div>
              </div>
              <button
