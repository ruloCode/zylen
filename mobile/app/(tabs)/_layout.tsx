 ...
 * icon frames, glowing top edge and active underline. Habit creation lives
 * in the Rituales tab ("Nueva rutina"), so there is no global FAB.
 */
...
function HudTabBar({ state, navigation }: HudTabBarProps) {
  ...
  // Android resizes the window under the keyboard, which would push this
  // absolutely-positioned bar on top of focused inputs — hide it instead.
