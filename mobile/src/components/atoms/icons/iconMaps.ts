/**
 * Centralized Icon Mappings — React Native port.
 *
 * Identical to the web version but backed by lucide-react-native
 * (same icon names; icons take `size`/`color` props on native).
 */
