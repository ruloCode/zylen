...
| `03-achievement-badges.json` | Medallones de logros | 16 | ⏳ pendiente |
| `04-life-area-gems.json` | Gemas/tótems de áreas de vida | 6 | ⏳ pendiente |
| `05-habit-catalog-illustrations.json` | Ilustración por hábito del catálogo | 20 | ⏳ pendiente |
